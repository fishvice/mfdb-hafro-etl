...
shrimp_station_fixes <- function(stodvar){
  ...
  expanded_stodvar <-
    ...
    dplyr::mutate( skiki = nvl2(skiki.fx, skiki.fx, skiki),
                   ...
                   fjardarreitur = ifelse(!is.na(fjardarreitur.fx) & (leidangur %in% leidangur_full), fjardarreitur.fx, fjardarreitur)
    ) %>%
